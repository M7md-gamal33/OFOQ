              ...
              <div className="pt-3 px-5">
                ...
                <form>
                  ...
                  />:<> <div className="first-popup-word pt-3 ">
                          <p className='text-dark fw-medium mb-0 pb-1'>Comment</p>
                        </div>
              
                         <ReactQuill modules={module} className="custom-quill-editor custom-quill-toolbar w-100" theme="snow" value={value} onChange={setValue} />
                      </>}
                  </div>
